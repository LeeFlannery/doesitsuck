...
INSERT INTO Review(Title,Body,Link,Category,Rating,Date_Created) VALUES('Civilzation V','Take over the world one hexagon at a time.','www.civilization5.com','Games',5,DATEADD(hh,RAND(3),DATEADD(dd,RAND(1),@date)))
